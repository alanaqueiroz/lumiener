...
<head>
    ...
    <title>Lumiener - Empresarial</title>
        ...
        <div class="calculator-container">
            ...
            <form method="POST" action="">
                ...
                <div class="calculator-input">
                    ...
                    <div>
                        <input type="range" min="3001" max="30000" id="valor-conta" name="valor-conta" value="5000" step="1"
                            oninput="updateTextInput(this.value);" />
                        <output id="rangeValue">R$ 5000,00</output>
                    </div>
                </div>
                <div class="calculator-input">
                ...
                <div class="calculator-input">
                    ...
                    <input type="range" id="valor-tarifa" name="valor-tarifa" min="0.00" max="5.00" value="1.00"
                        step="0.01" oninput="updateTarifaDisplay(this.value);">
                    <output id="tarifa-display">R$ 1,00</output>
                </div>
                <div class="calculator-input">
